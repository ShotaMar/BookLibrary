...
<body>
	<div class="container">
		...
		<div class="main">
			...
			<h2>
				<span>Google Books APIからタイトル検索</span>
			</h2>
			<br>
			<!-- タイトル検索フォーム -->
			<form action="AController?action=executeTitleSearch " method="post">
				<p class="inputForm2">
					書籍名： <span class="input2"><input type="text" name="title"></span>
				</p>
			...
			<br> <br> <br>
			<p>
				<a href="AController?action=fromTitleSearchToMngBook"
